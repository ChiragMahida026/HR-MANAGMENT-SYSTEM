<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="HR_MANAGMENT_SYSTEM.Details" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <div class="form-group">
                            <span lang="EN-US">Qualification</span><asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Qualification" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
